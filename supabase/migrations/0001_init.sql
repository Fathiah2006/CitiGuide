...
-- Convert the ASCII price placeholders ('##') into Naira signs using chr() so
-- the value is encoding-safe regardless of how this file was pasted/encoded.
-- (chr(8358) = ₦)
update public.listings
set price = repeat(chr(8358), char_length(price))
where price ~ '^#+$';
